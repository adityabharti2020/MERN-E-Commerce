...
export default function ProductList() {
  ...
  // products.map((data) => console.log(data.brand));
            ...
            <section aria-labelledby="products-heading" className="pb-24 pt-6">
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                ...
                <div className="lg:col-span-3">
                  <ProductGrid products={products?.data} filters={filters} />
                </div>
                {/* Product Grid End */}
              </div>
            </section>
...
function Pagination({
  ...
  // console.log("pages inpagination", page);
  // console.log("limits", ITEMS_PER_PAGE);
          ...
          <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
            {products?.map((product) => (
              <Link to={`/product-detail/${product.id}`} key={product.id}>
                <div
                  key={product.id}
                  className="group relative border-solid border-2 p-2 border-gray-400 w-auto h-auto"
                >
                  ...
                  <div className="mt-4 flex flex-col">
                    ...
                    <div className="py-1 flex justify-between items-center">
                      <p className="text-sm text-gray-500 flex items-center">
                        <StarIcon className="w-4 h-4 text-red-400 inline" />
